...
type DeliveryOrderDetail struct {
	...
	MasterItemId    string   `gorm:"not null;type:varchar(36);default:'';index"`
	UnitPrice       float64  `gorm:"type:decimal(15,2);not null;default:0"`
	PriceSource     string   `gorm:"not null;type:varchar(10);default:HNA"`
	LineTotal       float64  `gorm:"type:decimal(15,2);not null;default:0"`
