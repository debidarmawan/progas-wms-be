...
func Routes(f *fiber.App, db *gorm.DB) {
	...
	deliveryOrderUsecase := usecase.NewDeliveryOrderUsecase(txManager, deliveryOrderRepo, cylinderRepo, cylinderLedgerRepo, customerRepo, fleetRepo, auditLogRepo, customerItemPriceUsecase)
